...
- source authority is frozen per parameter, not through a global “microstructure literature” admission label;
- every parameter must have its own admissible source classes, applicability rule and deterministic multiple-source rule before numerical source inspection;
...
Current friction/model-risk state:
...
`JOINT_COST_SCENARIO_NUMERICAL_CONSTRUCTION = NOT_YET_CONSUMABLE`
