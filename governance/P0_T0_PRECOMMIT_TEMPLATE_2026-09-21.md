# P0 t0 PRECOMMIT TEMPLATE — 2026-09-21

## Status

`T0_PRECOMMIT_TEMPLATE = AUTHORITATIVE_TEMPLATE / NOT_YET_EXECUTABLE`

`t0 = NOT_DECLARED`

This authoritative template becomes usable only after:
