...
- Meilleur DSR : **BuyHold** (0.567).
- **Aucun signal actif ne bat le Buy & Hold avec un DSR > 0.95.** Résultat **cohérent avec l'Étape A** : sur le NASDAQ Composite quotidien (5 ans, un seul cycle), il n'y a pas d'edge directionnel robuste net de coûts. Le R²/accuracy proche de 50 % le confirme.
