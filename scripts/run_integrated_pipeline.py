...
- Univers de 5 variantes EXACTEMENT, aucun ajout a posteriori (N=5 pour le DSR) :
  ...
  src/integrated_pipeline.py, pas retouchees apres avoir vu le resultat
  combine ci-dessous).
...
w("Objectif (cf. `CLAUDE.md`, Étape D) : vérifier que la **combinaison** des "
  ...
  "de Buy & Hold (déjà traité dans `results/etape_D_overlay_optimized.md`).\n")
w("Aucun des trois moteurs n'est réinventé : le primaire, le secondaire du "
  ...
  "dans les études précédentes du repo (`results/meta_labeling_multi.md` : "
  "secondaire LogitL2, DSR=0.866 ; `results/etape_D_overlay_optimized.md` : "
