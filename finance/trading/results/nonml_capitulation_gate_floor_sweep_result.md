...
- candidats mesurés (`.npz` au schéma `pos` disponible) : **33**
- candidats détectés mais **non mesurés** faute de `.npz` : **29**
...
- `dispersion_trend_vol_targeting_overlay` (verdict au rapport : PASS)
...
- `momentum_breadth_vol_targeting_overlay` (verdict au rapport : PASS)
...
- `momentum_dispersion_trend_and_overlay` (verdict au rapport : PASS)
- `multimarket_breadth_vol_targeting_overlay` (verdict au rapport : PASS)
- `net_breadth_vol_targeting_overlay` (verdict au rapport : PASS)
...
- `santa_vol_targeting_overlay` (verdict au rapport : PASS)
- `skewness_vol_targeting_overlay` (verdict au rapport : FAIL)
- `sma200_breadth_vol_targeting_overlay` (verdict au rapport : PASS)
- `sma200_momentum_breadth_and_overlay` (verdict au rapport : PASS)
- `trend_lowvol_vol_targeting_overlay` (verdict au rapport : FAIL)
- `vix_regime_vol_targeting_overlay` (verdict au rapport : FAIL)
- `weakness_breadth_vol_targeting_overlay` (verdict au rapport : PASS)
...
- candidats structurellement **inactifs** (< 2 %) : **1**
- dont **PASS vides** : **1**
