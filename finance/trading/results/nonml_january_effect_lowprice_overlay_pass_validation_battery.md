# Batterie de validation renforcée — january_effect_lowprice_overlay

Coût pré-enregistré : 5.0 bps. 1375 séances. Schéma `.npz` : **portefeuille**.

## a. Stress de coûts (1x, 3x, 5x)

| Coût (bps) | Sharpe overlay | Sharpe BH | Rendement overlay | Rendement BH | PASS |
|---|---|---|---|---|---|
| 5.0 | +1.30 | +1.26 | +470.2% | +373.6% | OUI |
| 15.0 | +1.29 | +1.26 | +465.4% | +372.0% | OUI |
| 25.0 | +1.29 | +1.26 | +460.6% | +370.4% | OUI |
...
| Resserrement 2022 | 251 | -36.5% | -30.6% | non |
...
SR0 (seuil de sélection) = 0.0716 (journalier), DSR = 0.6487
**ÉCHEC — DSR>0,95 : NON.**
