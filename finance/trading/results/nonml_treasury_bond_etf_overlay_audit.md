# Audit — Momentum de l'ETF obligataire TLT (log-return 21j)
...
- TLT brut jour précédent (2026-08-05) = 83.000000, TLT brut jour de la transition (2026-08-06) = 82.519997 (valeurs distinctes vérifiées : OUI)
- TLTmom_lag(2026-08-06) — n/a directement (comparaison via momentum, voir alignement §1) 
- **OK — transition non aveugle confirmée**

## Anti-lookahead (NDX, troncature à 6268 séances)
