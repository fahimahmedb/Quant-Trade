...
Point pré-enregistré : CUT = 0.5x. Grille : {0.4x, 0.5x, 0.6x}. La porte ET elle-même (les 3 tercile expanding déjà validées au #200/#322/#327) n'est pas perturbée — seul le plancher de position l'est.

**Perturbation, pas retuning** : le verdict du cycle reste celui du point pré-enregistré (0,5x) quelle que soit la lecture de ce tableau.
