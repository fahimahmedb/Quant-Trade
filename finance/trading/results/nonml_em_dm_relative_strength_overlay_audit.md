# Audit — Force relative EM/DM (EEM/SPY, log-return 21j)
...
- Ratio brut jour précédent (2026-08-05) = 0.085374, ratio brut jour de la transition (2026-08-06) = 0.084600 (valeurs distinctes vérifiées : OUI)
- **OK — transition non aveugle confirmée**

## Anti-lookahead (NDX, troncature à 6446 séances)
