# Batterie de validation renforcée — amihud_illiquidity_tilt

Coût pré-enregistré : 5.0 bps. 1270 séances. Schéma `.npz` : **portefeuille**.

## a. Stress de coûts (1x, 3x, 5x)

| Coût (bps) | Sharpe overlay | Sharpe BH | Rendement overlay | Rendement BH | PASS |
|---|---|---|---|---|---|
| 5.0 | +1.19 | +0.90 | +334.1% | +171.6% | OUI |
| 15.0 | +1.19 | +0.90 | +332.9% | +171.4% | OUI |
| 25.0 | +1.19 | +0.90 | +331.7% | +171.3% | OUI |
...
SR0 (seuil de sélection) = 0.0717 (journalier), DSR = 0.5475
**ÉCHEC — DSR>0,95 : NON.**
