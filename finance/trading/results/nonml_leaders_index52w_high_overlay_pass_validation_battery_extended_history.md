...
|---|---|---|---|---|
| Dot-com crash | 752 | -41.6% | -40.4% | non |
| Crise financière 2008 | 378 | -49.7% | -49.7% | OUI |
| Krach COVID | 62 | -31.8% | -29.6% | non |
| Resserrement 2022 | 251 | -26.1% | -25.2% | OUI |
...
| 2 | 3497 | 11/1984→09/1998 | +1.50 | +0.88 | OUI |
| 3 | 3497 | 09/1998→08/2012 | +1.21 | +0.53 | OUI |
| 4 | 3499 | 08/2012→07/2026 | +1.63 | +1.02 | OUI |

**OK — 3/4 folds battus (majorité requise).**

## d. SPA de Hansen à 1 candidat contre la référence

t_SPA = 12.289, **p = 0.0000** (bootstrap stationnaire, H0 : la référence Leaders 1.0x n'est battue par aucun candidat).

**OK — seuil p < 0,05.**

## e. DSR avec n_trials = taille du backlog AVANT ce cycle (jamais 1)

n_trials=161 (backlog avant ce cycle), var(SR essais) extraite sur 68 Sharpe du backlog = 2.0173e-01 (annualisée) → 8.0052e-04 (journalière). Sharpe quotidien +0.0786, seuil SR₀ = 0.0762, z = +0.28, **DSR = 0.612**.
