...
|---|---|---|---|---|---|
| 5.0 | +0.45 | +0.39 | +139.9% | +98.9% | OUI |
| 15.0 | +0.44 | +0.39 | +133.1% | +98.6% | OUI |
| 25.0 | +0.43 | +0.39 | +126.5% | +98.2% | OUI |
...
| Krach COVID | 62 | -34.9% | -32.8% | non |
| Resserrement 2022 | 251 | -34.5% | -34.5% | OUI |
...
n_trials = 275 (taille du backlog après le #268), Var(Sharpe essais) estimée sur 105 Sharpe extraits du backlog = 0.000595 (échelle journalière).
DSR = 0.0129
**ÉCHEC — DSR ≥ 0.95 : NON.**
