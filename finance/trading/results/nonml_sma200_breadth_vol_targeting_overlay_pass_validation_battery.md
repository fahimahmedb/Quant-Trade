# Batterie de validation renforcée — sma200_breadth_vol_targeting_overlay

Coût pré-enregistré : 5.0 bps. 1186 séances. Schéma `.npz` : **exposition**.

## a. Stress de coûts (1x, 3x, 5x)

| Coût (bps) | Sharpe overlay | Sharpe BH | Rendement overlay | Rendement BH | PASS |
|---|---|---|---|---|---|
| 5.0 | +0.66 | +0.60 | +122.0% | +92.8% | OUI |
| 15.0 | +0.63 | +0.60 | +114.7% | +92.6% | OUI |
| 25.0 | +0.60 | +0.60 | +107.7% | +92.4% | OUI |
...
SR0 (seuil de sélection) = 0.0716 (journalier), DSR = 0.1490
**ÉCHEC — DSR>0,95 : NON.**
