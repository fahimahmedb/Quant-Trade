# Batterie de validation renforcée — momentum_decile_spread_vol_targeting_overlay_pit_universe
...
|---|---|---|---|---|---|
| 5.0 | +0.84 | +0.79 | +755.8% | +542.3% | OUI |
| 15.0 | +0.81 | +0.79 | +683.0% | +541.7% | OUI |
| 25.0 | +0.77 | +0.79 | +616.4% | +541.0% | non |
...
SR0 (seuil de sélection) = 0.0717 (journalier), DSR = 0.1717
**ÉCHEC — DSR>0,95 : NON.**
