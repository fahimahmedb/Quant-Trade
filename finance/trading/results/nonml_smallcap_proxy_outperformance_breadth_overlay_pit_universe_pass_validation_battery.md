# Batterie de validation renforcée — smallcap_proxy_outperformance_breadth_overlay_pit_universe
...
|---|---|---|---|---|---|
| 5.0 | +0.82 | +0.79 | +715.5% | +542.3% | OUI |
| 15.0 | +0.75 | +0.79 | +587.4% | +541.7% | non |
| 25.0 | +0.68 | +0.79 | +479.4% | +541.0% | non |
...
SR0 (seuil de sélection) = 0.0717 (journalier), DSR = 0.1539
**ÉCHEC — DSR>0,95 : NON.**
