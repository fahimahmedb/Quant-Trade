# Batterie de validation renforcée — weakness_breadth_vol_targeting_overlay_pit_universe
...
|---|---|---|---|---|---|
| 5.0 | +0.76 | +0.76 | +597.8% | +597.4% | OUI |
| 15.0 | +0.76 | +0.76 | +597.8% | +596.7% | OUI |
| 25.0 | +0.76 | +0.76 | +597.8% | +596.0% | OUI |
...
SR0 (seuil de sélection) = 0.0716 (journalier), DSR = 0.1045
**ÉCHEC — DSR>0,95 : NON.**
