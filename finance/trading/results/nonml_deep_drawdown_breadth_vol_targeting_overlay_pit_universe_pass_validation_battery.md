# Batterie de validation renforcée — deep_drawdown_breadth_vol_targeting_overlay_pit_universe
...
|---|---|---|---|---|---|
| 5.0 | +0.82 | +0.79 | +698.4% | +542.3% | OUI |
| 15.0 | +0.79 | +0.79 | +628.3% | +541.7% | OUI |
| 25.0 | +0.75 | +0.79 | +564.3% | +541.0% | non |
...
SR0 (seuil de sélection) = 0.0716 (journalier), DSR = 0.1583
**ÉCHEC — DSR>0,95 : NON.**
