# Batterie de validation renforcée — net_breadth_vol_targeting_overlay_pit_universe

Coût pré-enregistré : 5.0 bps. 2896 séances. Schéma `.npz` : **exposition**.

## a. Stress de coûts (1x, 3x, 5x)

| Coût (bps) | Sharpe overlay | Sharpe BH | Rendement overlay | Rendement BH | PASS |
|---|---|---|---|---|---|
| 5.0 | +0.79 | +0.76 | +930.4% | +597.4% | OUI |
| 15.0 | +0.76 | +0.76 | +835.3% | +596.7% | non |
| 25.0 | +0.73 | +0.76 | +749.0% | +596.0% | non |
...
SR0 (seuil de sélection) = 0.0717 (journalier), DSR = 0.1244
**ÉCHEC — DSR>0,95 : NON.**
