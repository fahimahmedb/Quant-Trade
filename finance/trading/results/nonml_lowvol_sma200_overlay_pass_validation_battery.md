# Batterie de validation renforcée — lowvol_sma200_overlay

Coût pré-enregistré : 5.0 bps. 1336 séances. Schéma `.npz` : **portefeuille**.

## a. Stress de coûts (1x, 3x, 5x)

| Coût (bps) | Sharpe overlay | Sharpe BH | Rendement overlay | Rendement BH | PASS |
|---|---|---|---|---|---|
| 5.0 | +0.72 | +0.66 | +122.4% | +60.8% | OUI |
| 15.0 | +0.70 | +0.65 | +117.4% | +59.6% | OUI |
| 25.0 | +0.68 | +0.64 | +112.5% | +58.3% | OUI |
...
| Resserrement 2022 | 251 | -25.6% | -17.0% | non |
...
SR0 (seuil de sélection) = 0.0716 (journalier), DSR = 0.1684
**ÉCHEC — DSR>0,95 : NON.**
