...
## Backlog #0-42 complet (28/07/2026)

18 PASS sur 42 hypothèses testées (#4, #8, #11, #14, #17, #21, #23, #29, #30, #32, #33, #34, #35, #37, #38, #39, #41, #42 — #14, #30 et #42 sous prudence forte, #32 avec robustesse partielle, #41 sans valeur ajoutée (identique au #33). **#38 = MEILLEUR résultat du backlog** : Sharpe +0,78→+1,50, MDD quasi inchangé, plateau parfait sur 2 grilles de robustesse. Le signal "proximité du plus haut 52-semaines indice" (#37) surperforme systématiquement SMA200 en combinaison et réussit même là où le calendrier échoue (#42 vs #18 sur Winners). Les signaux de tendance COURTS (MACD/#36, Donchian-20/#40) échouent nettement — seuls les signaux LONGS (SMA200/#29, 52w-high/#37) fonctionnent comme overlay de levier).
