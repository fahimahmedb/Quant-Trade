...
## Backlog #0-39 complet (28/07/2026)

16 PASS sur 39 hypothèses testées (#4, #8, #11, #14, #17, #21, #23, #29, #30, #32, #33, #34, #35, #37, #38, #39 — #14 et #30 sous prudence forte, #32 avec robustesse partielle, **#38 = MEILLEUR résultat du backlog à ce stade** : Sharpe +0,78→+1,50, MDD quasi inchangé, plateau parfait sur 2 grilles de robustesse. Le signal "proximité du plus haut 52-semaines indice" (#37) surperforme systématiquement SMA200 en combinaison, sur momentum (#38>#33) comme sur low-vol (#39>#35)).
...
| 40 | Breakout de Donchian (20 séances) : overlay levé quand la clôture dépasse le plus haut des 20 dernières séances (signal de suivi de tendance court terme, horizon très différent du #37 qui utilise 252j) | OHLC déjà en local | à faire |
