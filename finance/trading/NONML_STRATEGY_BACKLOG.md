...
## Backlog #0-37 complet (28/07/2026), 3 nouvelles idées (#38-40)

14 PASS sur 37 hypothèses testées (#4, #8, #11, #14, #17, #21, #23, #29, #30, #32, #33, #34, #35, #37 — #14 et #30 sous prudence forte, #32 avec robustesse partielle, **#37 = meilleure préservation du MDD parmi les signaux de tendance seuls**).

| 38 | Combiner Leaders 52-semaines (#4) + overlay proximité plus haut 52-semaines indice (#37, meilleure préservation de MDD parmi les signaux de tendance) — variante du #33 avec un signal de tendance différent | prix NDX-100 déjà récupérés | à faire |
