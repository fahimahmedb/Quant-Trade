...
## Backlog #0-38 complet (28/07/2026)

15 PASS sur 38 hypothèses testées (#4, #8, #11, #14, #17, #21, #23, #29, #30, #32, #33, #34, #35, #37, #38 — #14 et #30 sous prudence forte, #32 avec robustesse partielle, **#38 = MEILLEUR résultat du backlog à ce stade** : Sharpe +0,78→+1,50, MDD quasi inchangé, plateau parfait sur 2 grilles de robustesse).
...
| 39 | Combiner Low-Volatility tilt (#15) + overlay proximité plus haut 52-semaines indice (#37) — variante du #35 avec un signal de tendance différent | prix NDX-100 déjà récupérés | à faire |
