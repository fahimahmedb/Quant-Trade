...
| 51 | Combiner Winners momentum court terme (#14, prudence forte) + mécanisme hiérarchique tendance+vol-targeting (#47, PASS robuste) au lieu du simple overlay binaire déjà testé (#42) — teste si le mécanisme le plus sophistiqué de la session améliore encore le meilleur edge brut du backlog | prix NDX-100 déjà récupérés | à faire |
