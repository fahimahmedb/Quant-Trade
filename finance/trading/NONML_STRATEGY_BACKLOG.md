...
## Backlog #0-36 complet (28/07/2026)

13 PASS sur 36 hypothèses testées (#4, #8, #11, #14, #17, #21, #23, #29, #30, #32, #33, #34, #35 — #14 et #30 sous prudence forte, #32 avec robustesse partielle, **#33 et #35 = meilleur ratio gain/MDD, le filtre SMA200 préserve le MDD défensif là où le calendrier échoue**).
...
| 37 | Distance au plus haut 52-semaines AU NIVEAU INDICE (pas titre comme #4) : overlay levé quand l'indice est proche de son plus haut annuel (régime de force), signal de tendance encore différent de SMA200/Golden Cross | OHLC déjà en local | à faire |
