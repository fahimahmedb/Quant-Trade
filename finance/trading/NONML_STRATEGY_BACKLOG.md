...
## Backlog #0-34 complet (28/07/2026), 3 nouvelles idées (#35-37)

12 PASS sur 34 hypothèses testées (#4, #8, #11, #14, #17, #21, #23, #29, #30, #32, #33, #34 — #14 et #30 sous prudence forte, #32 avec robustesse partielle, **#33 = meilleur ratio gain/MDD à ce stade**).

| 35 | Combiner low-volatility tilt (#15) + overlay filtre de tendance SMA200 (#29) : teste si le trend-filter (qui a très bien fonctionné avec le momentum #33) aide aussi le portefeuille défensif, contrairement à l'overlay calendaire (#28, FAIL) | prix NDX-100 déjà récupérés | à faire |
