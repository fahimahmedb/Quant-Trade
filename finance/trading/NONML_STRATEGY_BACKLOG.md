...
## Backlog #0-40 complet (28/07/2026), 3 nouvelles idées (#41-43)

16 PASS sur 40 hypothèses testées (#4, #8, #11, #14, #17, #21, #23, #29, #30, #32, #33, #34, #35, #37, #38, #39 — #14 et #30 sous prudence forte, #32 avec robustesse partielle, **#38 = MEILLEUR résultat du backlog à ce stade** : Sharpe +0,78→+1,50, MDD quasi inchangé, plateau parfait sur 2 grilles de robustesse. Le signal "proximité du plus haut 52-semaines indice" (#37) surperforme systématiquement SMA200 en combinaison, sur momentum (#38>#33) comme sur low-vol (#39>#35). Les signaux de tendance COURTS (MACD/#36, Donchian-20/#40) échouent nettement — seuls les signaux LONGS (SMA200/#29, 52w-high/#37) fonctionnent comme overlay de levier).

| 41 | Combiner Leaders 52-semaines (#4) + overlay UNION des deux meilleurs signaux de tendance (SMA200 #29 ∪ 52w-high indice #37) : teste si l'union apporte un gain net vs le #38 (52w-high seul) ou dilue l'edge comme observé au #32 (union sur Buy&Hold) | prix NDX-100 déjà récupérés | à faire |
