...
| E3 | Momentum cross-actifs sur le quatuor actions/obligations/or/dollar (signal : allocation vers les jambes en tendance positive, réduite/nulle sur les jambes en tendance négative) | TLT, GLD, UUP (**récupérés et vérifiés**, confirmé sur le disque au #534) | **FAIT — FAIL niveau 1** (#535, `PREREG_crossasset_tsmom_overlay.md`) : TSMOM 252j, Sharpe overlay +0,83 vs BH +0,98, rendement +66,0% vs +104,3%, MDD amélioré (-9,9% vs -17,6%) mais insuffisant. Voir `results/nonml_crossasset_tsmom_overlay_{result,audit,anti_cheat}.md` |
