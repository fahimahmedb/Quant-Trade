...
PREREG_momentum_consistency_trend_vol_targeting_overlay.md, committée
avant ce script). Combine les cycles #82, #29 et le mécanisme
hiérarchique #47/#51/#53. n_trials=1, aucune dépendance ML. Règle de
...
def main():
    ...
    lines = [
        "# Résultat — Momentum de constance + overlay combiné tendance + vol-targeting (pré-enregistré, combinaison #82+#29+#47/#51/#53)",
        "",
        ...
        f"| **Momentum de constance + overlay tendance+vol-targeting** | **{me_lev['sharpe_ann']:+.2f}** | "
