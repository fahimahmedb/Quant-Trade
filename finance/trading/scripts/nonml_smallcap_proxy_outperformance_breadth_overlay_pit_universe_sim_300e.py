"""Simulation 300 EUR — breadth « petites caps » proxy, univers POINT-IN-TIME.
...
Usage : python3 scripts/nonml_smallcap_proxy_outperformance_breadth_overlay_pit_universe_sim_300e.py
"""
import sys
...
CAPITAL0 = 300.0
WINDOW_DAYS = 63
OUT = ROOT / "results" / "nonml_smallcap_proxy_outperformance_breadth_overlay_pit_universe_sim_300e.md"
...
def main():
    ...
    L = [
        ...
        f"| **Overlay gaté breadth petites caps (PIT)** | **{eq_ov[-1]:.2f} EUR** | "
    ...
    L.append("**Lecture honnête** : 63 séances n'ont **aucune valeur statistique**. Le verdict "
             "du cycle reste celui du backtest complet (2645 séances, 2016-2026, PASS niveau 1) "
             "et de la grille de robustesse (4/4 sur CAP, 2/4 sur la fenêtre de vol).")
    L.append("")
    L.append("Rappel : un PASS de niveau 1 n'est **pas** un verdict final (Règle 9). La "
             "batterie renforcée du candidat d'origine donne 1/5.")
    L.append("")
