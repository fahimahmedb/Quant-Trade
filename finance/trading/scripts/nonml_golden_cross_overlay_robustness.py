"""Robustesse — Overlay Golden Cross SMA50/SMA200. Grille CAP (PAS un
...
from nonml_golden_cross_overlay_backtest import golden_cross_mask, COST_BPS, SMA_LONG, MARKETS  # noqa: E402
...
def main():
    lines = [
        "# Robustesse — Overlay Golden Cross SMA50/SMA200 (grille CAP, PAS un retuning)",
        "",
    ...
    out = ROOT / "results" / "nonml_golden_cross_overlay_robustness.md"
    out.write_text("\n".join(lines) + "\n")
    print("\n".join(lines))
    print(f"\nÉcrit dans {out}")
