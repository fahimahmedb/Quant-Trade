"""Simulation — 300 EUR, Leaders 52-semaines + overlay SMA200 levé, ~3
...
def main():
    ...
    lines = [
        "# Simulation — 300 EUR, Leaders 52-semaines + overlay SMA200 levé (~3 derniers mois)",
        "",
        ...
        f"| **Leaders + overlay SMA200 x{CAP}** | **{equity_lev[-1]:.2f} EUR** | "
    ...
    out = ROOT / "results" / "nonml_sma200_leaders_overlay_sim_300e.md"
    out.write_text("\n".join(lines) + "\n")
    print("\n".join(lines))
    print(f"\nÉcrit dans {out}")
