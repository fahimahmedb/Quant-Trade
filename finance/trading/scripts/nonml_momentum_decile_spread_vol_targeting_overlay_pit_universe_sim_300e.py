"""Simulation 300 EUR — spread décile de momentum, univers POINT-IN-TIME.
...
Usage : python3 scripts/nonml_momentum_decile_spread_vol_targeting_overlay_pit_universe_sim_300e.py
"""
import sys
...
CAPITAL0 = 300.0
WINDOW_DAYS = 63
OUT = ROOT / "results" / "nonml_momentum_decile_spread_vol_targeting_overlay_pit_universe_sim_300e.md"
...
def main():
    ...
    L = [
        ...
        f"| **Overlay gaté spread décile (PIT)** | **{eq_ov[-1]:.2f} EUR** | "
    ...
    L.append("**Lecture honnête** : 63 séances n'ont **aucune valeur statistique**. Le verdict "
             ...
             "et de la grille de robustesse (4/4 sur CAP, 3/4 sur la fenêtre de vol).")
    L.append("")
