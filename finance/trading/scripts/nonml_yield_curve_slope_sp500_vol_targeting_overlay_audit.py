...
def main():
    ...
    lines = ["# Audit adversarial — Pente de la courbe des taux US appliquée au S&P 500", "",
    ...
    out = ROOT / "results" / "nonml_yield_curve_slope_sp500_vol_targeting_overlay_audit.md"
    out.write_text("\n".join(lines) + "\n")
    print("\n".join(lines))
    print(f"\nÉcrit dans {out}")
