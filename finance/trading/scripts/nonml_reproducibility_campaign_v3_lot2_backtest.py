"""Campagne de reproductibilité v3, LOT 2 — resserrer la borne (#440).
...
OUT = RESULTS / "nonml_reproducibility_campaign_v3_lot2_result.md"

SEED, SAMPLE_SIZE, TIMEOUT_S = 20260818, 24, 300
SEED_LOT1, SIZE_LOT1 = 20260817, 24   # lot 1 du #438, a exclure
DENOM_LOT1 = 23                       # tirages retenus au #438
...
def main():
    ...
    remaining = [n for n in pool if n not in lot1]
    ...
    if substantive:
        ...
        L.append(f"- tirages retenus **au #438** : **{DENOM_LOT1}**")
        L.append("")
        L.append("| | Dénominateur | Borne à 95 % |")
        L.append("|---|---|---|")
        L.append(f"| #438 seul | {DENOM_LOT1} | 12,2 % |")
        L.append(f"| ce lot seul | {denom} | {100*b_lot:.1f} % |")
        L.append(f"| **cumul #438 + #440** | **{cum}** | **{100*b:.1f} %** |")
        L.append("")
