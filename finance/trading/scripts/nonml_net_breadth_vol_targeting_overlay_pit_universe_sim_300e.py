"""Simulation 300 EUR — breadth nette hauts-bas, univers POINT-IN-TIME.
...
Usage : python3 scripts/nonml_net_breadth_vol_targeting_overlay_pit_universe_sim_300e.py
"""
import sys
...
CAPITAL0 = 300.0
WINDOW_DAYS = 63
OUT = ROOT / "results" / "nonml_net_breadth_vol_targeting_overlay_pit_universe_sim_300e.md"
...
def main():
    ...
    L = [
        ...
        f"| **Overlay gaté breadth nette (PIT)** | **{eq_ov[-1]:.2f} EUR** | "
