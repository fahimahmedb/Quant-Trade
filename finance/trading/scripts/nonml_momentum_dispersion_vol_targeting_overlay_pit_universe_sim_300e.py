...
Usage : python3 scripts/nonml_momentum_dispersion_vol_targeting_overlay_pit_universe_sim_300e.py
"""
import sys
...
CAPITAL0 = 300.0
WINDOW_DAYS = 63
OUT = ROOT / "results" / "nonml_momentum_dispersion_vol_targeting_overlay_pit_universe_sim_300e.md"
...
def main():
    ...
    L = [
        ...
        f"| **Overlay gaté dispersion (PIT)** | **{eq_ov[-1]:.2f} EUR** | "
    ...
    L.append("**Lecture honnête** : 63 séances n'ont **aucune valeur statistique**. Le verdict "
             ...
             "et de la grille de robustesse (voir le rapport de robustesse).")
    L.append("")
